using KitchenStock.Components.Pages.Dialogs.Category;
using KitchenStock.Components.ViewModels;
using KitchenStock.Models;
using Microsoft.AspNetCore.Components;
using MudBlazor;

namespace KitchenStock.Components.Pages.Categories
{
    public partial class Categories
    {
        ...
        /// </summary>
        /// <param name="aCateGoryModel">The CategoryModel to edit, or a new CategoryModel</param>
        /// <param name="aNewCategory">Indicates if the CategoryModel already exsists or not</param>
